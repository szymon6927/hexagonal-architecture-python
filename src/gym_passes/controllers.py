...
@router.post("/gym-passes", response_model=GymPassDTO, tags=["gym_passes"])
...
@router.post("/gym-passes/{gym_pass_id}/pauses", response_model=GymPassDTO, tags=["gym_passes"])
async def pause(
...
@router.put("/gym-passes/{gym_pass_id}/renewal", response_model=GymPassDTO, tags=["gym_passes"])
...
@router.get("/gym-passes/{gym_pass_id}/verification", response_model=GymPassDTO, tags=["gym_passes"])
